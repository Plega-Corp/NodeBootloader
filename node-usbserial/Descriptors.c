...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
{
	...
	.ReleaseNumber          = VERSION_BCD(0,0,2),// VERSION_BCD(Major, Minor, Revision)
	...
	.CDC_Functional_Header =
		{
			...
			.CDCSpecification       = VERSION_BCD(1,1,0),// VERSION_BCD(Major, Minor, Revision)
		},
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(L"Plega (www.plega.io)");
 ...
 *  Descriptor.
 */
USB_Descriptor_String_t PROGMEM const ProductString = USB_STRING_DESCRIPTOR(L"Plega Node");

	...
	.Config =
		{
			...
			.ConfigAttributes       = (USB_CONFIG_ATTR_RESERVED | USB_CONFIG_ATTR_BUSPOWERED | USB_CONFIG_ATTR_SELFPOWERED),
 ...
 *  Descriptor.
 */
USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"Plega Node");
